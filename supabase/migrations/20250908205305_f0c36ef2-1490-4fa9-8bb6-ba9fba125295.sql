-- Aktualizacja triggera dla lepszego zarządzania terapeutami - z poprawnym usuwaniem

-- Usuń wszystkie zależne triggery najpierw
DROP TRIGGER IF EXISTS therapist_role_management_trigger ON public.user_roles CASCADE;
DROP TRIGGER IF EXISTS therapist_role_trigger ON public.user_roles CASCADE;

-- Teraz usuń funkcję
DROP FUNCTION IF EXISTS public.handle_therapist_role_changes() CASCADE;
